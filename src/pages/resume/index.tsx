    ...
    <div id="resume" className="mx-8 lg:mx-28 mb-14">
      <div>
        ...
        <div className="flex justify-between lg:flex-row flex-col">
          <div>
            <h3 className="text-3xl font-semibold lg:mt-6">Work Experience</h3>
            <div className="my-11">
              <div className="flex">
            ...
            <div className="my-11 flex flex-col gap-6">
              <div>
                <div className="flex">
                  <h4 className="text-xl">EcoClub, Visakha Valley School</h4>
                </div>
              ...
              <div>
                <div className="flex">
                  <h4 className="text-xl">Maths Club, Visakha Valley School</h4>
                </div>
          ...
          <div>
            ...
            <div className="my-11 flex flex-col gap-6">
              <div>
                <div className="flex">
                  <h4 className="text-xl">Northmoor Edison Primary School</h4>
                  <Link
              ...
              <div>
                <div className="flex">
                  <h4 className="text-xl">M.P. & E.V. English Medium School</h4>
                </div>
              ...
              <div>
                <div className="flex items-end">
                  ...
                  <Link href="https://www.gitam.edu/" className=" ml-2 mb-1">
                    <ArrowUpRight className="p-1" />
                  </Link>
                </div>
        ...
        <h3 className="text-3xl font-semibold lg:mt-6">Community Experience</h3>
          ...
          <div className="w-3/4">
            ...
            <div className="my-11 flex flex-col gap-6">
              ...
              <div>
                ...
                <div className="flex mt-2">
                  <h5 className="text-md font-semibold">Compose Pathway</h5>
                  <Link
